    ...
    if new_channel_url or selected_channel:
        ...
        try:
            ...
            if info_yt.check_history():
                ...
                #st.write(f'The latest video stored was published: {info_yt.most_recent_date}')
                #st.write(f'The oldest video stored was published: {info_yt.oldest_date}')
            else:
            ...
            if st.button("Update video "):
                if info_yt.check_history():
                    st.write(info_yt.update_videos(verbose=True))
